...
def getGenomeSpaceToken(username, password, gsDNS):
    data={"openid.ns":"http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0","openid.identity":"http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select","openid.claimed_id":"http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select","openid.mode":"checkid_setup","openid.realm":"https%3A%2F%2F"+gsDNS+"%2Fjsui%2FopenIdClient%3Fis_return%3Dtrue","openid.return_to":"https://"+gsDNS+"/jsui/openIdClient?is_return=true","user_name":username,"password":password}
